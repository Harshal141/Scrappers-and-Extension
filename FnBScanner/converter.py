...
input_json_file = "./FnBScanner/DATA_319_ensun_ai.json"  # Replace with the path to your JSON file
output_csv_file = "./FnBScanner/DATA_319_ensun_result.csv"  # Replace with the desired CSV output path
