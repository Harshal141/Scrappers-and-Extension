...
input_json_file = "serper/DATA_332/41_80/fnb_41_80_ai.json"  # Replace with the path to your JSON file
output_csv_file = "serper/DATA_332/41_80/fnb_41_80_ai.csv"  # Replace with the desired CSV output path
