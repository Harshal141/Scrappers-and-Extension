...
input_json_file = "./FnBScanner/dnb_usa_fnb_ai.json"  # Replace with the path to your JSON file
output_csv_file = "./FnBScanner/dnb_usa_fnb_ai.csv"  # Replace with the desired CSV output path
