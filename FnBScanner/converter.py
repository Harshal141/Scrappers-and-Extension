...
input_json_file = "FnBWarehouse/fnb_test/fnb_scrapped_ai.json"  # Replace with the path to your JSON file
output_csv_file = "FnBWarehouse/fnb_test/fnb_scrapped_ai.csv"  # Replace with the desired CSV output path
