...
input_json_file = "./FnBScanner/DATA_297_thomas_2_ai.json"  # Replace with the path to your JSON file
output_csv_file = "./FnBScanner/DATA_297_thomas_2_result.csv"  # Replace with the desired CSV output path
