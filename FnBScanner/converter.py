...
input_json_file = "./FnBScanner/DATA_300_pacGlobal_ai.json"  # Replace with the path to your JSON file
output_csv_file = "./FnBScanner/DATA_300_pacGlobal_ai.csv"  # Replace with the desired CSV output path
