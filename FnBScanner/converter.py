...
input_json_file = "FnBWarehouse/data_ai.json"  # Replace with the path to your JSON file
output_csv_file = "FnBWarehouse/data_ai.csv"  # Replace with the desired CSV output path
