...
# input_csv_file = "./FnBWarehouse/datacanada.csv"  # Replace with the path to your CSV file
# output_json_file = "./FnBWarehouse/indexed_datacanada.json"  # Output JSON file path
...
input_file = "./FnBWarehouse/urlList.json"
output_file ="./FnBWarehouse/urlList_indexed.json"
