...
input_csv_file = "FnBWarehouse/fnb_request.csv"  # Replace with the path to your CSV file
output_json_file = "FnBWarehouse/fnb_request_source.csv"  # Output JSON file path
